...
tg: t.me/IoTeXDoge
https://twitter.com/iotexDoge - King of  Doges (When Iotexdoge Arrives, Shiba hides)
www:IoTeXDoge.com
*/
...
library DogeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "DogeMath: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "DogeMath: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "DogeMath: multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "DogeMath: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "DogeMath: modulo by zero");
    }
...
contract IoTeXDoge is Context, IERC20, Ownable {
    using DogeMath for uint256;
    ...
    string private _name = "IoTexDoge";
    string private _symbol = "IODOGE";
    ...
    address payable public marketingWallet =
        payable(0xE46dc33C63e4dA96642b34F3D2Dea4de7401F017);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 0.1 * 10**9 * 10**9; // 0.1% of total supply
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9; //1% of total supply
    uint256 public _maxWalletToken = 10 * 10**9 * 10**9; //10% of total supply
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x95cB18889B968AbABb9104f30aF5b310bD007Fd8
        ); //v2 router
        // Create a Mimo pair for this new token
    ...
    function excludeFromReward(address account) public onlyOwner {
        require(
            account != 0x95cB18889B968AbABb9104f30aF5b310bD007Fd8,
            "We can not exclude Mimo router."
        ); //v2
    ...
    //to recieve iotx from uniswapV2Router when swaping
